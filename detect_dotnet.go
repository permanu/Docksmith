...
func dotnetWebFramework(dir, csproj, name string) *Framework {
...
func detectAspNetCore(dir string) *Framework {
	csproj := findCsproj(dir)
	if csproj == "" {
		return nil
	}
...
func detectBlazor(dir string) *Framework {
	csproj := findCsproj(dir)
	if csproj == "" {
		return nil
	}
...
func detectDotnetWorker(dir string) *Framework {
	csproj := findCsproj(dir)
	if csproj == "" {
		return nil
	}
