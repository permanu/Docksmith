...
func detectGoGin(dir string) *Framework {
...
func detectGoEcho(dir string) *Framework {
...
func detectGoFiber(dir string) *Framework {
...
func detectGoStd(dir string) *Framework {
