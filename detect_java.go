...
func detectSpringBoot(dir string) *Framework {
...
func detectQuarkus(dir string) *Framework {
	jv := detectJavaVersion(dir)
...
func detectMicronaut(dir string) *Framework {
	jv := detectJavaVersion(dir)
...
func detectMavenGeneric(dir string) *Framework {
...
func detectGradleGeneric(dir string) *Framework {
	gradleFile := ""
