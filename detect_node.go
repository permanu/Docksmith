...
func detectNextJS(dir string) *Framework {
...
func detectNuxt(dir string) *Framework {
...
func detectSvelteKit(dir string) *Framework {
...
func detectAstro(dir string) *Framework {
...
func detectRemix(dir string) *Framework {
...
func detectGatsby(dir string) *Framework {
...
func detectVite(dir string) *Framework {
...
func detectCRA(dir string) *Framework {
...
func detectAngular(dir string) *Framework {
	serveCmd := func(pm string) string {
		switch pm {
		case "pnpm":
...
func detectVueCLI(dir string) *Framework {
	serveCmd := func(pm string) string {
		switch pm {
		case "pnpm":
			return "pnpm exec serve dist"
...
func detectSolidStart(dir string) *Framework {
	if !hasFile(dir, "package.json") {
		return nil
	}
...
func detectNestJS(dir string) *Framework {
...
func detectExpress(dir string) *Framework {
...
func detectFastify(dir string) *Framework {
